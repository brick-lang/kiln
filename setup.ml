...
(* OASIS_START *)
(* DO NOT EDIT (digest: 25538777498d8ce42d96923eba6e428d) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "kiln.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest =
       Some "\174\174\237\133\127uW\168\165\130y\238\135\030\207U";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
