...
and ident_vector = ident_create "vector"
...
and path_vector = Pident ident_list
...
and type_vector t = newgenty (Tconstr(path_list, [t], ref Mnil))
  ...
  add_type ident_int64 decl_abstr (
    add_type ident_int32 decl_abstr (
      add_type ident_option decl_option (
        add_type ident_vector decl_vector (
